...
function get_historical_stock_data_parquet(
    ...
    try
        ...
        file_path = joinpath("mnt", "parquet_tmpfs", "$ticker.parquet")
    ...
    try
        ...
        cached_data = read_parquet_with_duckdb(
            ...
            joinpath(
                "mnt",
                "parquet_tmpfs",
                "rsi_$(ticker)_$(length_data)_$(period)_$(end_date).parquet",
            ),
        )
...
# without indicator file cache
n_experiments = 10
# println("Execution times without indicator file cache: ")
run_experiments(n_experiments)

# # Empty line
# println("")

# # with indicator file cache
# n_experiments = 10
# println("Execution times with indicator file cache: ")
# run_experiments(n_experiments)
